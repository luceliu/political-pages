...
Promise.all([
  ...
  let handlers = {
    ...
    onRatingMouseover: onRatingMouseover, onRatingMouseout: onRatingMouseout
  };
  ...
  createSmallMultiples(data);

  createCategoryEngagement(data);
...
createRankedVis = (data, perPageData, pageCategories, handlers) => {
  let pageRankings = new circleJuxtaposeVis({
    ...
    onRatingMouseout: handlers.onRatingMouseout,
    onRatingMouseover: handlers.onRatingMouseover,
...
createTruthPercentage = (data, perPageData, pageCategories) => {
